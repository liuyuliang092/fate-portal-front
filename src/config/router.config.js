...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      {
        // path: '/site',
        // redirect: '/site/newsite',
        // component: RouteView,
        // meta: { title: 'Demo', icon: 'form', permission: ['AlgoDag'] },
        // children: [
        //   {
        //     path: '/dag/algo',
        //     name: 'AlgoDag',
        //     component: () => import('@/views/dag/AlgoDag'),
        //     meta: { title: 'AlgoDag', keepAlive: true }
        //   }
        // ]
        path: '/site',
        name: 'Site',
      ...
      //       name: 'AlgoDag',
      //       component: () => import('@/views/dag/AlgoDag'),
      //       meta: { title: 'AlgoDag', keepAlive: true, permission: ['AlgoDag'] }
      //     }
      //   ]
      // },
      //butterfly
